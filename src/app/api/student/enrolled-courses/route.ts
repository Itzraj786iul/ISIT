/**
 * @legacy MARKETPLACE_LMS — Enrolled `Course` list + next `Lesson` id from `StudentProfile.completedLessons`.
 * AI equivalent: sessions + last-session + topic links (docs/AI_FIRST_MIGRATION.md).
 */
