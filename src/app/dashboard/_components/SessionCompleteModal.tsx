    ...
    >
      ...
      <div className="relative w-[90%] max-w-md max-h-[min(90vh,640px)] overflow-y-auto overscroll-contain rounded-2xl border border-emerald-200/80 bg-white shadow-2xl shadow-emerald-900/10 motion-safe-transition mx-auto my-auto">
        <button
          type="button"
          onClick={handleClose}
          className="absolute top-2 right-2 sm:top-3 sm:right-3 min-h-[44px] min-w-[44px] inline-flex items-center justify-center rounded-xl text-slate-400 hover:text-slate-600 dark:text-slate-300 hover:bg-slate-100 z-10 active:scale-95"
          aria-label="Dismiss"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="bg-gradient-to-br from-emerald-500 via-teal-500 to-sky-600 px-4 pt-7 pb-5 sm:px-6 sm:pt-8 sm:pb-6 text-white text-center">
          <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-white/20 backdrop-blur mb-3">
            <Sparkles className="w-7 h-7 sm:w-8 sm:h-8 text-slate-900 dark:text-white" aria-hidden />
          </div>
        ...
        <div className="px-4 py-4 sm:px-6 sm:py-5 space-y-3">
          <div className="grid grid-cols-3 gap-2 sm:gap-3 min-w-0">
            <div className="rounded-xl bg-slate-50 border border-slate-100 px-2 py-2.5 sm:px-3 sm:py-3 text-center">
              ...
              <div className="text-[10px] sm:text-[11px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide">Time spent</div>
            </div>
            <div className="rounded-xl bg-slate-50 border border-slate-100 px-2 py-2.5 sm:px-3 sm:py-3 text-center">
              ...
              <div className="text-[10px] sm:text-[11px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide">Answered</div>
            </div>
            <div className="rounded-xl bg-slate-50 border border-slate-100 px-2 py-2.5 sm:px-3 sm:py-3 text-center">
              ...
              <div className="text-[10px] sm:text-[11px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide">Accuracy</div>
            </div>
          </div>
          {stats.questionsAnswered > 0 && (
        ...
        <div className="px-4 pb-4 sm:px-6 sm:pb-6 flex flex-col gap-2">
          ...
          >
            ...
            <span className="text-xs font-normal text-slate-500 dark:text-slate-400 mt-0.5 max-w-full truncate px-1">
