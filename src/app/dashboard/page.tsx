...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex font-sans dark:bg-slate-950 overflow-x-hidden">
      <Sidebar />
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden dark:bg-slate-900 dark:border-slate-700">
              ...
              <div className="p-4 sm:p-5 overflow-x-hidden">
                ...
                {!loading && recentTopics.length > 0 && (
                  ...
                  >
                    View all progress <ChevronRight className="w-4 h-4 shrink-0" />
                  </Link>
                )}
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden dark:bg-slate-900 dark:border-slate-700">
              ...
              <div className="p-4 sm:p-5 space-y-2">
                ...
                >
                  ...
                  <span className="font-medium flex-1 min-w-0 text-sm sm:text-base">My progress</span>
