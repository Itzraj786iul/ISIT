...
export default function ErrorPage({
  ...
  return (
    <div className="isit-cosmic-bg min-h-screen flex flex-col items-center justify-center px-4 text-cyan-50 relative">
      <div className="isit-glass max-w-md w-full rounded-3xl p-8 text-center">
        ...
        <h2 className="text-2xl font-bold text-cyan-50 mb-3">Something went wrong</h2>
        ...
        <p className="mt-6 text-xs text-cyan-200/55">
