    ...
    <div className="min-h-screen bg-[#f1f5f9] p-6 md:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-8 shadow-sm text-center">
          ...
          <h1 className="text-xl font-bold text-slate-800 mb-2">Students</h1>
          <p className="text-slate-500 text-sm">View and manage your students. This section will be available in a future update.</p>
        </div>
      </div>
    </div>
  );
